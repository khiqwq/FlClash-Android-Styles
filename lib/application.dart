...
import 'package:fl_clash/widgets/native_liquid_navigation_bridge.dart';
    ...
    return Consumer(
      builder: (_, ref, child) {
        ...
        return MaterialApp(
          ...
          navigatorObservers: [nativeLiquidNavigationRouteObserver],
          ...
          builder: (_, child) {
            return PredictiveBackCoordinator(
              child: AppEnvManager(
                child: _buildApp(
