...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "blur": MessageLookupByLibrary.simpleMessage("模糊顶部和底部栏"),
    "blurDesc": MessageLookupByLibrary.simpleMessage("使用半透明背景模糊顶部和底部栏"),
    ...
    "floatingBottomBar": MessageLookupByLibrary.simpleMessage("悬浮底部栏"),
    ...
    "interfaceStyle": MessageLookupByLibrary.simpleMessage("界面风格"),
    ...
    "liquidGlass": MessageLookupByLibrary.simpleMessage("液态玻璃"),
    "liquidGlassDesc": MessageLookupByLibrary.simpleMessage(
      "为悬浮底部栏添加裁剪模糊、半透明色调和高光",
    ),
    ...
    "portTip": m21,
    "predictiveBack": MessageLookupByLibrary.simpleMessage("预测性返回动画"),
    "predictiveBackDesc": MessageLookupByLibrary.simpleMessage(
      "在受支持的 Android 返回手势中预览上一屏",
    ),
    ...
    "themeDesc": MessageLookupByLibrary.simpleMessage("自定义界面风格、主题模式与色彩"),
