...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "blur": MessageLookupByLibrary.simpleMessage("上下のバーをぼかす"),
    "blurDesc": MessageLookupByLibrary.simpleMessage("半透明の背景で上下のバーをぼかします"),
    ...
    "floatingBottomBar": MessageLookupByLibrary.simpleMessage("フローティングボトムバー"),
    "floatingBottomBarDesc": MessageLookupByLibrary.simpleMessage(
      "連続した角丸でボトムバーをコンテンツ上に浮かせます",
    ),
    ...
    "interfaceStyle": MessageLookupByLibrary.simpleMessage("インターフェーススタイル"),
    ...
    "liquidGlass": MessageLookupByLibrary.simpleMessage("リキッドガラス"),
    "liquidGlassDesc": MessageLookupByLibrary.simpleMessage(
      "フローティングボトムバーにクリップされたぼかし、半透明の色合い、ハイライトを追加します",
    ),
    ...
    "portTip": m21,
    "predictiveBack": MessageLookupByLibrary.simpleMessage("予測型戻るアニメーション"),
    "predictiveBackDesc": MessageLookupByLibrary.simpleMessage(
      "対応する Android の戻るジェスチャーで前の画面をプレビューします",
    ),
    ...
    "theme": MessageLookupByLibrary.simpleMessage("テーマ設定"),
    "themeColor": MessageLookupByLibrary.simpleMessage("テーマカラー"),
    "themeDesc": MessageLookupByLibrary.simpleMessage(
      "インターフェース、テーマモード、色をカスタマイズ",
    ),
