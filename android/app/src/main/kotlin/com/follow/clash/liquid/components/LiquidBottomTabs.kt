package com.follow.clash.liquid.components
...
import com.follow.clash.liquid.LiquidBottomBarGeometry
import com.follow.clash.liquid.utils.DampedDragAnimation
import com.follow.clash.liquid.utils.InteractiveHighlight
...
fun LiquidBottomTabs(
    ...
    onDraggingChanged: (dragging: Boolean) -> Unit = {},
    backdrop: Backdrop,
    tabsCount: Int,
    ...
    val isLightTheme = !(isDarkTheme ?: isSystemInDarkTheme())
    val accentColor =
    ...
    BoxWithConstraints(
        ...
        val dampedDragAnimation = remember(animationScope, tabsCount, isLtr) {
            DampedDragAnimation(
                ...
                onDragStarted = { currentOnDraggingChanged(true) },
                onDragStopped = {
                ...
                onDrag = { _, dragAmount ->
                    updateValue(
                        (targetValue + dragAmount.x / tabWidth * directionMultiplier)
        ...
        DisposableEffect(Unit) {
            onDispose { currentOnDraggingChanged(false) }
        }
        ...
        val interactiveHighlight = remember(animationScope, tabWidth, isLtr, dampedDragAnimation) {
            InteractiveHighlight(
                ...
                position = { size, offset ->
                    Offset(
                        LiquidBottomBarGeometry.indicatorCenter(
                            totalWidth = size.width,
                            tabWidth = tabWidth,
                            value = dampedDragAnimation.value,
        ...
        Box(
            Modifier
                .padding(horizontal = 4f.dp)
                .graphicsLayer {
                    translationX = LiquidBottomBarGeometry.indicatorTranslation(
                        value = dampedDragAnimation.value,
                        tabWidth = tabWidth,
                        panelOffset = panelOffset,
                        isLtr = isLtr,
